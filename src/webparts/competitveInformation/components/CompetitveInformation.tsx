...
import styles from './CompetitveInformation.module.scss';
import type { ICompetitveInformationProps } from './ICompetitveInformationProps';
import { SPFI, SPFx, spfi } from "@pnp/sp/presets/all";
import { DetailsList, DetailsListLayoutMode, IColumn,  Stack } from '@fluentui/react';
import { ICompetitiveInformationState } from './ICompetitiveInformation.State';
...
export default class CompetitveInformation extends React.Component<ICompetitveInformationProps, ICompetitiveInformationState> {
  ...
  async componentDidMount(): Promise<void> {
    ...
    const data: { Name: any;Modified:any; ModifiedBy: any; FileType: string;FileRed:string;FileLeafRef:string; }[] = [];
      ...
      try {
        ...
        const internalTraning = await commonService.getItems('Competitive Information');
  ...
  public render(): React.ReactElement<ICompetitveInformationProps> {
    return (
      <Stack>
