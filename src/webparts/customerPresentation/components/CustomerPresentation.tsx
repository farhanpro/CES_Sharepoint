...
export default class CustomerPresentation extends React.Component<ICustomerPresentationProps, {}> {
  public render(): React.ReactElement<ICustomerPresentationProps> {
    ...
    return (
      <section className={`${styles.customerPresentation} ${hasTeamsContext ? styles.teams : ''}`}>
